...
const Spain = (props) => {
    ...
    return (
        ...
        <svg id={childKey} xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x={cx - 10} y={cy - 10} width={20} height={20} viewBox="0 0 1024 1024" style={{ enableBackground: 'new 0 0 512 512' }} >
